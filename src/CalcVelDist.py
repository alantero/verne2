...
#from CalcVelDist_depth_function import calcVelDist_full
...
parser.add_argument('-int', '--interaction', help='Interaction type: `SI`, `SD`, `hm`, `ulm` or `Millicharge`.', type=str, default="SI")
