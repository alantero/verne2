...
where
  ...
  - `INTERACTION` is the type of the type of interaction, either "SI" (Spin-independent),  "SD" (spin-dependent), "hm"/"ulm" (dark sector interactions mediated by a heavy or ultralight mediator) or "Millicharge" (Millicharged DM).
